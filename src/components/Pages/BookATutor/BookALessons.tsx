...
const BookALessons = () => {
  ...
  return (
    <section className=" 3xl:w-[806px] h-auto w-auto bg-white rounded-[12px] p-8 flex flex-col gap-y-10 ">
      ...
      <Button className="primary-btn !w-full " Txt={`Continue To Payment`} />
    </section>
  );
};

    ...
    <main className="flex flex-col gap-y-8">
      <div className="flex flex-col gap-y-3 ">
        <Heading
          ...
          className=" font-[600] text-[32px] text-secondary-black"
        />
        <Paragraph
          Txt={`Credentials & Qualifications`}
          className=" font-normal text-base  text-primary-gray"
        />
      </div>
      <div className="flex flex-row gap-x-10  ">
        <div className="flex flex-col">
          <div className=" h-auto w-auto bg-white border-[1px] border-solid p-8 border-secondry-gray rounded-[12px] flex flex-col gap-y-4 ">
            <Heading
            ...
            {activeTutor?.educationDeatisArr.map((item, idx) => {
              return (
                <div
                  key={idx}
                  className="flex flex-row gap-x-[84px] h-auto w-auto bg-white p-6 rounded-[12px] border-[1px] border-solid border-secondry-gray  "
                >
                  <div className="flex flex-col gap-y-4  ">
                    ...
                    <div className="flex flex-row gap-4 ">
                      <div className="-auto w-auto bg-white px-[22.5px] cursor-pointer flex flex-row gap-x-3 items-center  py-2 rounded-[12px] border-[1px] border-solid border-secondry-gray ">
                        <EyeIcon />
                        <Paragraph
        ...
        <div className="h-auto w-auto bg-white p-8 rounded-[12px] border-[1px] border-solid border-secondry-gray flex flex-col gap-y-8  ">
          <Heading
          ...
          <ul className="flex pl-6 flex-col gap-y-4 ">
            {teacherDetailsArr.map((item, idx) => {
              return (
                <li
                  className="text-base font-normal text-black list-disc list-group-item-primary "
                  key={idx}
                >
                  {item}
                </li>

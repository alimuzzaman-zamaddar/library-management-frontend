  ...
  return (
    <div className="">
      ...
      <div className=" max-w-[860px] mx-auto">
        ...
        <div className="bg-white p-8 border border-alt-border rounded-lg mb-8">
          <div className="mt-6">
            <h3 className="text-secondary-black text-[24px] font-semibold leading-[36px]">
              Community Guidelines
            </h3>
            <div className="mt-4">
              <h3 className="text-secondary-black text-[16px] font-semibold leading-[36px]">

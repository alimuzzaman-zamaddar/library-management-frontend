...
const FeedbackForm = () => {
  ...
  return (
    ...
    >
      <h1 className="text-[32px] font-semibold text-center mb-4">
        How was your lesson?
      </h1>
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <div className="text-sm text-gray-600 flex items-center gap-2">
              Sarah Johnson · <FaStar className="text-yellow-400" /> 4.9 · 1247
              lessons
            </div>
      ...
      {/* Rating */}
      <div className="mb-6 p-8 bg-white rounded-lg shadow-md border border-[var(--color-alt-border)]">
        <label className="block text-[24px] font-semibold not-italic leading-none mb-6">
          Rate your lesson
        </label>
      ...
      <div className="p-8 bg-white rounded-lg shadow-md border border-[var(--color-alt-border)] mb-6">
        <div className="mb-6">
          <label className="block text-[24px] font-semibold not-italic leading-none mb-5">
      ...
      <div className="p-8 bg-white rounded-lg shadow-md border border-[var(--color-alt-border)] mb-6">
        <div className="mb-6">
          <label className="block text-[24px] font-semibold not-italic leading-none mb-2">

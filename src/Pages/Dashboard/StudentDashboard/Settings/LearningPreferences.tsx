      ...
      <div className="w-full max-w-3xl mx-auto bg-bg-white p-8 rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <section className="mb-8">
            ...
            <div className="mb-4">
              <label className="block text-secondary-black text-[16px] font-semibold leading-[150%] mb-2">
                Subjects I'm Learning
              </label>
              <input
                type="text"
            ...
            {/* Current Level */}
            <div className="mb-4">
              <label className="block text-[16px] font-semibold leading-[150%] text-secondary-black mb-2">
                Current Level
              </label>
              <select
                className="w-full border border-alt-border px-4 py-2 rounded-md"

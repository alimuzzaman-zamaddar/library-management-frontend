  ...
  return (
    <div className="w-full max-w-3xl mx-auto py-10">
      <div>
        ...
        />
        <Paragraph
          className="text-text-gray font-normal text-[16px]  leading-[150%] mb-5"
        ...
        <div className="mb-6">
          <div className="flex space-x-3">
            <div className="bg-bg-light-gray px-2 py-[5px] flex items-center  rounded-[28px] ">
              {(["Profile", "Preferences", "Billing", "Privacy"] as const).map(
                (tab) => {
                  type TabType =
                    | "Profile"
                    | "Preferences"
                  ...
                  return (
                    <button
                      ...
                      className={`${
                        activeTab === tab
                          ? "text-primary-blue bg-white rounded-[28px]"
                          : "text-text-gray"
                      } py-1 px-4 text-sm font-semibold flex items-center space-x-2`}
      ...
      <div className="w-full  ">
        <div>
          {activeTab === "Profile" && (
            <>
              ...
              <div className=" bg-white mb-4 p-8 rounded-lg shadow-lg">
                ...
                />
                <Paragraph
                  className="text-text-gray font-normal text-[16px]  leading-[150%] mb-10"
                    ...
                    <div className="w-[80%] space-y-4">
                      <div className="flex gap-3">
                        <div className="w-1/2">
                          <label
                            htmlFor="firstName"
                            className="block text-text-gray mb-2"
                          >
                            First Name
                          </label>
                          <input
                          ...
                          {errorsProfile.firstName && (
                            <p className="text-red-500 text-sm mt-1">
                              {typeof errorsProfile.firstName?.message === "string"
                        ...
                        <div className="w-1/2">
                          ...
                          {errorsProfile.lastName && (
                            <p className="text-red-500 text-sm mt-1">
                              {typeof errorsProfile.lastName?.message === "string"
                      ...
                      <div className="mb-4">
                        ...
                        {errorsProfile.displayName && (
                          <p className="text-red-500 text-sm mt-1">
                            {typeof errorsProfile.displayName?.message === "string"
                      ...
                      <div className="flex gap-3">
                        <div className="mb-4 w-1/2">
                          ...
                          {errorsProfile.country && (
                            <p className="text-red-500 text-sm mt-1">
                              {typeof errorsProfile.country?.message === "string"
                        ...
                        <div className="mb-4 w-1/2">
                          ...
                          {errorsProfile.phoneNumber && (
                            <p className="text-red-500 text-sm mt-1">
                              {typeof errorsProfile.phoneNumber?.message === "string"
                      ...
                      <div className="mb-4">
                        ...
                        {errorsProfile.timezone && (
                          <p className="text-red-500 text-sm mt-1">
                            {typeof errorsProfile.timezone?.message === "string"
                      ...
                      <div className="flex justify-end">
                        <button
                          type="submit"
                          className="bg-primary-blue border hover:border-alt-border hover:bg-white hover:text-text-blue duration-700 text-white px-6 py-2 cursor-pointer rounded-[8px] flex items-center gap-3"
                        >
                          Save Changes
                        </button>
                      </div>
                ...
                <section className="mt-8 bg-white p-8 rounded-lg shadow-lg">
                  ...
                  <div className="mb-4">
                    ...
                    {errorsPassword.currentPassword && (
                      <p className="text-red-500 text-sm mt-1">
                        {typeof errorsPassword.currentPassword?.message === "string"
                  ...
                  <div className="mb-4">
                    ...
                    {errorsPassword.newPassword && (
                      <p className="text-red-500 text-sm mt-1">
                        {typeof errorsPassword.newPassword?.message === "string"
                  ...
                  <div className="mb-4">
                    ...
                    {errorsPassword.confirmNewPassword && (
                      <p className="text-red-500 text-sm mt-1">
                        {typeof errorsPassword.confirmNewPassword?.message === "string"
          ...
          {activeTab === "Preferences" && (
            <div>
              <h3 className="text-xl text-text-gray mb-3">
          ...
          {activeTab === "Billing" && (
            <div>
              <h3 className="text-xl text-text-gray mb-3">Billing Settings</h3>
          ...
          {activeTab === "Privacy" && (
            <div>
              <h3 className="text-xl text-text-gray mb-3">Privacy Settings</h3>
